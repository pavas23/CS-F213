...
class PavasFrame extends Frame {
    ...
    PavasFrame(String title) {
        ...
        // Flow layout is very useful to prevent overflow of components in the frame
        // container
        // as if we change the screen size the components gets adjusted automatically to
        // the next line
        ...
        li.add("one");
        /*
         * when using flow layout no need to setBounds for each component as it
         * automatically sets
         * location of the components in the given frame.If we add dimensions also then
         * also no difference
